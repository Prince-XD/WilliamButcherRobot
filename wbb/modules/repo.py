...
async def repo(_, message):
    users = await fetch(
        "https://api.github.com/repos/GhangaleSangram/WilliamButcherRobot/contributors"
    )
    list_of_users = ""
    count = 1
    for user in users:
    ...
    text = f"""[Github](https://github.com/GhangaleSangram) | [Group](t.me/TheProgrammerCaT_Bot)
```----------------
| Contributors |
----------------```
{list_of_users}"""
